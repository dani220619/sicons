...
<nav class="main-header navbar navbar-expand navbar-default navbar-dark navbar-cyan">
	...
	<ul class="navbar-nav ml-auto">
		<li class="nav-item">
			<b><span id="jam" style="font-size:28px"></span></b>
		</li>
		...
		<li class="nav-item">
			<a href="#" class="nav-link">
				<div class="user-panel">
					<!-- <div class="image"> -->
					<img src="<?php echo base_url(); ?>assets/foto/user/<?php echo $this->session->userdata['image']; ?>" class="img-circle" alt="User Image" style="height: 35px;">
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
				...
				<?php if ($_SESSION["id_level"] == ("2")) { ?>
					<li class="nav-item">
						<a href="<?= base_url('kuesioner/kuesioner_admin') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-question text-bold"></i>
							<p>Kuesioner</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('materi') ?>" class="nav-link">
							<i class="nav-icon fas fa-book text-bold"></i>
							<p>Materi Session</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('career/career_admin') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-user-md text-bold"></i>
							<p>Career Test</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('personality/personality_admin') ?>" class="nav-link">
							<i class="nav-icon fas  fa fa-user-plus text-bold"></i>
							<p>Personality Test</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('konseling/konseling_admin') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-user-md text-bold"></i>
							<p>Individual Konseling</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('group_konseling/konseling_admin') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-address-card text-bold"></i>
							<p>Group Konseling</p>
						</a>
					</li>
				<?php } ?>
				...
				<?php if ($_SESSION["id_level"] == ("3")) { ?>
					<li class="nav-item">
						<a href="<?= base_url('Pengisian/kuesioner') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-question text-bold"></i>
							<p>Kuesioner</p>
						</a>
					</li>
				...
				<?php if ($_SESSION["id_level"] == ("3")) { ?>
					<li class="nav-item">
						<a href="<?= base_url('career/siswa_career') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-user-md text-bold"></i>
							<p>Carrer</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url('personality/siswa_personality') ?>" class="nav-link">
							<i class="nav-icon fas  fa fa-user-plus text-bold"></i>
							<p>Personality Test</p>
						</a>
					</li>
				...
				<?php if ($_SESSION["id_level"] == ("3")) { ?>
					<li class="nav-item">
						<a href="<?= base_url('konseling/index') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-address-book text-bold"></i>
							<p>Individual Konseling</p>
						</a>
					</li>
				<?php } ?>
				<?php if ($_SESSION["id_level"] == ("3")) { ?>
					<li class="nav-item">
						<a href="<?= base_url('group_konseling/index') ?>" class="nav-link">
							<i class="nav-icon fas  fas fa-address-card text-bold"></i>
							<p>Group Konseling</p>
						</a>
					</li>
