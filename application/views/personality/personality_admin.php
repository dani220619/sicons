    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Personality Admin</h3>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-outline-primary" href="<?= base_url('personality/detail_personality/' . $d->nis . '') ?>" title="Tambah Jawaban"><i class="fa fa-plus"></i>
