    			...
    			<div class="col-12">
    				<div class="card">
    					<div class="card-header bg-light">
    						<h3 class="card-title"><i class="fa fa-list text-blue"></i> Data Career</h3>
    						<div class="text-right">

    							<button type="button" class="btn btn-sm btn-outline-primary" onclick="add_career()" title="Add Data"><i class="fas fa-plus"></i> Add</button>
    	...
    	<div class="modal-dialog">
    		<div class="modal-content">
    			...
    			<div class="modal-body">
    				...
    				<p>Apakah anda yakin ingin menghapus career <strong class="text-konfirmasi"> </strong> ?</p>
    			</div>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function() {
    		...
    		table = $("#tabelmenu").DataTable({
    			...
    			"ajax": {
    				"url": "<?php echo site_url('career/ajax_career') ?>",
    				"type": "POST"
    			},
    			...
    			"columnDefs": [{
    				...
    				"render": function(data, type, row) {
    					...
    					if (row[3] == '2') {
    						return "<a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"updatecareer(" + row[4] + ")\"><i class=\"fas fa-edit\"></i></a><a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\" onclick=\"delcareer(" + row[4] + ")\"><i class=\"fas fa-trash\"></i></a>"
    					} else {
    						return " <a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"updatecareer(" + row[4] + ")\"><i class=\"fas fa-edit\"></i></a><a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\" onclick=\"delcareer(" + row[4] + ")\"><i class=\"fas fa-trash\"></i></a>"
    					}
    				},
    	...
    	//view
    	function vcareer(id) {
    		$('.modal-title').text('View career');
    		$("#modal-default").modal('show');
    		$.ajax({
    			url: '<?php echo base_url('career/view_career'); ?>',
    			type: 'post',
    	...
    	function updatecareer(id) {
    		...
    		$.ajax({
    			url: "<?php echo site_url('career/edit_career') ?>/" + id,
    			type: "GET",
    			dataType: "JSON",
    			success: function(data) {
    				...
    				$('.modal-title').text('Edit career'); // Set title to Bootstrap modal title
    			},
    	...
    	function save() {
    		...
    		if (save_method == 'add') {
    			url = "<?php echo site_url('career/insert') ?>";
    		} else {
    			url = "<?php echo site_url('career/update') ?>";
    		}
