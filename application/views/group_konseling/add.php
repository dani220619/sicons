<div class="col-md-12">
	<div class="card card-primary card-outline">
		...
		<form class="pesan" method="post" action="<?= base_url('group_konseling/insert'); ?>" enctype="multipart/form-data">
			<div class="card-body">

				<input class="form-control" placeholder="nis" name="nis" id="nis" value="<?= $nis['nis'] ?>" hidden>
				<input class="form-control" placeholder="id_sekolah" name="id_sekolah" id="id_sekolah" value="<?= $nis['id_sekolah'] ?>" hidden>
