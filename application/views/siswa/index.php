                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-light">
                            <h3 class="card-title"><i class="fa fa-list text-blue"></i> Data Siswa</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $("#tabeluser").DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('siswa/ajax_list_siswa') ?>",
                    "type": "POST"
                },
                ...
                "columnDefs": [{
                        ...
                        "render": function(data, type, row) {
                            ...
                            if (row[4] == "N") {
                                ...
                                return "<a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" title=\"View\" onclick=\"vuser(" + row[5] + ")\"><i class=\"fas fa-eye\"></i></a> <a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit_user(" + row[5] + ")\"><i class=\"fas fa-edit\"></i><a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\"  onclick=\"deluser(" + row[5] + ")\"><i class=\"fas fa-trash\"></i></a></a> <a class=\"btn btn-xs btn-outline-warning\" href=\"javascript:void(0)\" title=\"Reset Password\" onclick=\"riset(" + row[5] + ")\"><i>Riset Pass</i></a>";
                            }
        ...
        function save() {
            ...
            var url;
            if (save_method == 'add') {
                url = "<?php echo site_url('siswa/insert') ?>";
            } else {
                ...
                <div class="modal-body form">
                    <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row ">
                                <label for="no_tlp" class="col-sm-3 col-form-label">No Tlp</label>
                                <div class="col-sm-9 kosong">
                                    <input type="text" class="form-control" name="no_tlp" id="no_tlp" placeholder="No Tlp">
                                </div>
                            </div>
                            <div class="form-group row ">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-9 kosong">
                                    <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" placeholder="Tempat Lahir">
                                </div>
                            </div>
                            <div class="form-group row ">
